...
data_E_IRR = Data_from_nc('CTL\EFLX_LH_TOT_timmean.nc')   #load the data
...
data_E_IRR = Data_from_nc('CTL\FSH_timmean.nc')   #load the data
...
data_E_IRR = Data_from_nc('CTL\SWup_timmean.nc')   #load the data
...
data_E_IRR = Data_from_nc('CTL\LWup_timmean.nc')   #load the data
...
plt.savefig('C:\Research1\Figures\\Energy1.png')
...
data_E_IRR = Data_from_nc('CTL\Qle_timmean.nc')   #load the data
...
data_E_IRR = Data_from_nc('CTL\QVEGT_timmean.nc')   #load the data
...
data_E_IRR = Data_from_nc('CTL\QRUNOFF_timmean.nc')   #load the data
...
data_E_IRR = Data_from_nc('CTL\TOTSOILLIQ_timmean.nc')   #load the data
...
#plt.show()
plt.savefig('C:\Research1\Figures\\Water1.png')
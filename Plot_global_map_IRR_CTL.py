...
data_E_NOI = Data_from_nc('CTL\EFLX_LH_TOT_timmean.nc')   #load the data
...
data_E_NOI = Data_from_nc('CTL\FSH_timmean.nc')   #load the data
...
data_E_NOI = Data_from_nc('CTL\SWup_timmean.nc')   #load the data
...
data_E_NOI = Data_from_nc('CTL\LWup_timmean.nc')   #load the data
...
plt.savefig('C:\Research1\Figures\\Energy2.png')

f = plt.figure(figsize = (12, 8), dpi=1000)  # initiate the figure
set_plot_param()

data_E_NOI = Data_from_nc('CTL\Qle_timmean.nc')   #load the data
...
data_E_NOI = Data_from_nc('CTL\QVEGT_timmean.nc')   #load the data
...
data_E_NOI = Data_from_nc('CTL\QRUNOFF_timmean.nc')   #load the data
...
data_E_NOI = Data_from_nc('CTL\TOTSOILLIQ_timmean.nc')   #load the data
...
#plt.show()
plt.savefig('C:\Research1\Figures\\Water2.png')